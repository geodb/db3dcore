 ...
 */
public class TriangleNet3DBuilder {
	...
	protected List<TriangleNet3DComponent> components;
	 ...
	 */
	public TriangleNet3DBuilder(Space3DC space) {
	 ...
	 */
	public TriangleNet3DBuilder(ScalarOperator sop) {
		this.compIDCounter = 0;
		this.space = null;
	 ...
	 *             Triangle3D.
	 */
	public void addComponent(TriangleNet3DElement[] elements) {

		// Build a new Component and fill the SAM
		TriangleNet3DComponent comp = new TriangleNet3DComponent(
				getScalarOperator(), elements);
	 ...
	 *             Triangle3D.
	 */
	public void addComponent(TriangleNet3DElement[] elements, int id) {
		TriangleNet3DComponent comp = new TriangleNet3DComponent(
				getScalarOperator(), elements);
		// Here an IllegalArgumentException can be thrown.
	...
	public TriangleNet3D getTriangleNet() {
		...
		TriangleNet3DComponent[] compnet = new TriangleNet3DComponent[components
				.size()];

		// alteration in array
		for (int i = 0; i < compnet.length; i++)
			compnet[i] = (TriangleNet3DComponent) components.get(i);
