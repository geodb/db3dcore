...
public class TetrahedronNet3DElement extends Tetrahedron3D implements NetElement3D {

	/* neighbour 0 */
	private TetrahedronNet3DElement eltZero;

	/* neighbour 1 */
	private TetrahedronNet3DElement eltOne;

	/* neighbour 2 */
	private TetrahedronNet3DElement eltTwo;

	/* neighbour 3 */
	private TetrahedronNet3DElement eltThree;

	/* id of this - unique in whole net */
	private int id;

	/* enclosing net component */
	private TetrahedronNet3DComponent comp;
	 ...
	 *             class Vector3D.
	 */
	public TetrahedronNet3DElement(Point3D[] points, ScalarOperator sop)
			throws IllegalArgumentException {
		super(points, sop);
		this.eltZero = null;
		this.eltOne = null;
	 ...
	 *             class Vector3D.
	 */
	public TetrahedronNet3DElement(Point3D point1, Point3D point2, Point3D point3,
	 ...
	 *             class Vector3D.
	 */
	public TetrahedronNet3DElement(Point3D point, Triangle3D triangle,
			ScalarOperator sop) {
	 ...
	 *             class Vector3D.
	 */
	public TetrahedronNet3DElement(Segment3D seg1, Segment3D seg2, ScalarOperator sop) {
	 ...
	 *             class Vector3D.
	 */
	public TetrahedronNet3DElement(Tetrahedron3D tetra) {
		super(tetra);
		this.eltZero = null;
		this.eltOne = null;
		this.eltTwo = null;
	 ...
	 *         if out of range.
	 */
	public TetrahedronNet3DElement getNeighbour(int index) {
		switch (index) {
		case 0:
			return this.eltZero;
		case 1:
	 ...
	 */
	public TetrahedronNet3DElement[] getNeighbours() {
		return new TetrahedronNet3DElement[] { this.eltZero, this.eltOne, this.eltTwo,
				this.eltThree };
	}
	 ...
	 */
	public TetrahedronNet3DComponent getNetComponent() {
		return comp;
	}
	 ...
	 */
	public void setNeighbour(int index, TetrahedronNet3DElement element)
			throws DB3DException {
		switch (index) {
		case 0:
	 ...
	 */
	public int setNeighbourNull(TetrahedronNet3DElement element, ScalarOperator sop) {
		
		TetrahedronNet3DElement neighbour = this.getNeighbour(0);
	 ...
	 */
	public void setNetComponent(TetrahedronNet3DComponent net3D) {
		comp = net3D;
	}
