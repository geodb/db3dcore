 ...
 */
public class PointNet3DElement extends Point3D implements NetElement3D {

	/* id of this - unique in whole net */
	private int id;

	/* enclosing net component */
	private PointNet3DComponent comp;

	/**
	 * Default constructor. Constructs a PointElt3D object as a Point3D with
	 * x,y,z = 0.0.
	 */
	public PointNet3DElement() {
		super();
	}
	 ...
	 */
	public PointNet3DElement(double x, double y, double z) {
		super(x, y, z);
	}
	 ...
	 */
	public PointNet3DElement(double[] coords) {
		super(coords);
	}
	 ...
	 *            Point3D
	 */
	public PointNet3DElement(Point3D point) {
		super(point);
	}
	 ...
	 */
	public PointNet3DComponent getNetComponent() {
		return comp;
	}
	 ...
	 */
	protected void setNetComponent(PointNet3DComponent net3D) {
		comp = net3D;
	}
	...
	public void readExternal(ObjectInput in) throws IOException,
		...
		this.id = in.readInt();
		this.comp = (PointNet3DComponent) in.readObject();
	}
