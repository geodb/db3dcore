...
public class TriangleNet3DElement extends Triangle3D implements NetElement3D {

	/* neighbour 0 */
	private TriangleNet3DElement eltZero;

	/* neighbour 1 */
	private TriangleNet3DElement eltOne;

	/* neighbour 2 */
	private TriangleNet3DElement eltTwo;

	/* id of this - unique in whole net */
	private int id;

	/* enclosing net component */
	private TriangleNet3DComponent comp;
	 ...
	 *             class Vector3D.
	 */
	public TriangleNet3DElement(Point3D[] points, ScalarOperator sop)
			throws IllegalArgumentException {
		super(points, sop);
		this.eltZero = null;
		this.eltOne = null;
	 ...
	 *             class Vector3D.
	 */
	public TriangleNet3DElement(Point3D point1, Point3D point2, Point3D point3,
			ScalarOperator sop) {
	 ...
	 *             class Vector3D.
	 */
	public TriangleNet3DElement(Point3D point, Segment3D seg, ScalarOperator sop) {
	 ...
	 *             class Vector3D.
	 */
	public TriangleNet3DElement(Triangle3D triangle) {
		super(triangle);
		this.eltZero = null;
		this.eltOne = null;
		this.eltTwo = null;
	 ...
	 *            TriangleElt3D
	 */
	public boolean setNeighbour(int index, TriangleNet3DElement element) {
		switch (index) {
		case 0:
	 ...
	 */
	public int setNeighbourNull(TriangleNet3DElement element, ScalarOperator sop) {
	 ...
	 */
	public TriangleNet3DElement getNeighbour(int index) {
		switch (index) {
		case 0:
			return this.eltZero;
		case 1:
	 ...
	 */
	public TriangleNet3DElement[] getNeighbours() {
		int counter = 0;
		...
		TriangleNet3DElement[] neighbours = new TriangleNet3DElement[counter];
	 ...
	 */
	public TriangleNet3DComponent getNetComponent() {
		return comp;
	}
	 ...
	 */
	public void setNetComponent(TriangleNet3DComponent net3D) {
		comp = net3D;
	}
	...
	public void makeNeighboursOrientationConsistent(ScalarOperator sop,
		...
		TriangleNet3DElement current = this;
		do {
			// set visited status
			flags.add(current);

			for (int i = 0; i < 3; i++) {
				TriangleNet3DElement nb = current.getNeighbour(i);
			...
			TriangleNet3DElement current2 = null;
			if (nbObj != null) {
				index = (Integer) nbObj[0];
				nb = (TriangleNet3DElement) nbObj[1];
				current2 = (TriangleNet3DElement) nbObj[2];
			}
	...
	public void invertOrientation() {
		...
		TriangleNet3DElement temp2 = getNeighbour(2);
