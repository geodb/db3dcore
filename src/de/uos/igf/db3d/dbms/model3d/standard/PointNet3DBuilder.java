 ...
 */
public class PointNet3DBuilder {
	 ...
	 */
	public PointNet3DBuilder(Space3DC space) {
	 ...
	 */
	public PointNet3DBuilder(ScalarOperator sop) {
		this.compIDCounter = 0;
		this.space = null;
	 ...
	 */
	public void addComponent(PointNet3DElement[] elements) {
		PointNet3DComponent comp = new PointNet3DComponent(elements, getScalarOperator());
	 ...
	 *             point is not greater than its minimum point.
	 */
	public void addComponent(PointNet3DElement[] elements, int id) {
		PointNet3DComponent comp = new PointNet3DComponent(elements, getScalarOperator());
		// Here an IllegalArgumentException can be thrown.
	...
	public PointNet3D getPointNet() {
		...
		PointNet3DComponent[] compnet = new PointNet3DComponent[components.size()];
		for (int i = 0; i < compnet.length; i++)
			compnet[i] = (PointNet3DComponent) components.get(i);
