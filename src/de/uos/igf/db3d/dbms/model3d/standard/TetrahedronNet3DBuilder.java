 ...
 */
public class TetrahedronNet3DBuilder {
	 ...
	 */
	public TetrahedronNet3DBuilder(Space3DC space) {
	 ...
	 */
	public TetrahedronNet3DBuilder(ScalarOperator sop) {
		this.compIDCounter = 0;
		this.space = null;
	 ...
	 *             class Vector3D.
	 */
	public boolean addComponent(TetrahedronNet3DElement[] elements) {
		TetrahedronNet3DComponent comp = null;
		try {
			comp = new TetrahedronNet3DComponent(getScalarOperator(), elements);
	 ...
	 *             class Vector3D.
	 */
	public boolean addComponent(TetrahedronNet3DElement[] elements, int id)
			throws DB3DException {
		TetrahedronNet3DComponent comp = null;
		comp = new TetrahedronNet3DComponent(getScalarOperator(), elements);
		// Here an IllegalArgumentException can be thrown.
	...
	public TetrahedronNet3D getTetrahedronNet() {
		...
		TetrahedronNet3DComponent[] compnet = new TetrahedronNet3DComponent[components
				.size()];
		for (int i = 0; i < compnet.length; i++)
			compnet[i] = (TetrahedronNet3DComponent) components.get(i);
