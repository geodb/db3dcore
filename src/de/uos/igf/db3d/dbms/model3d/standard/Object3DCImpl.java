 ...
 * 
 */
public class Object3DCImpl implements Object3DC {
	 ...
	 * @see Object3DC.dbms.model3d.Object3D#isRegisteredInSpace()
	 */
	 ...
	 */
	public void setSpace(Space3DC space) {
		this.space = space;
	}
	...
	public void setThematicinfos(LinkedHashMap<String, String> infos) {
		if (getSpace().getObjectByName(infos.get("name")) != null) {
