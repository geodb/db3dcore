...
/**
 * Class GeoEpsilon - for epsilon-based arithmetic comparisons.<br>
 * Currently the epsilon for the GeoEpsilon has to be something like<br>
 * 1/(10^n) where n is a natural number <br>
 * for example 0.01, 0.001, 0.0001 ... <br>
 * 
 * @author Wolfgang Baer / University of Osnabrueck
 */
public class GeoEpsilon implements Externalizable {
	 ...
	 */
	public GeoEpsilon(double epsilon) {
	 ...
	 * @return GeoEpsilon
	 */
	public GeoEpsilon copy() {
		return new GeoEpsilon(this.getEpsilon());
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GeoEpsilon other = (GeoEpsilon) obj;
