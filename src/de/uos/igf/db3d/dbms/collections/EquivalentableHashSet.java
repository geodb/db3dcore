 ...
 * <br>
 * All constructors need a GeoEpsilon for the equality/equivalence tests
...
public final class EquivalentableHashSet extends AbstractHashSet {
	 ...
	 * 
	 * @param _sop
	 *            GeoEpsilon for equality/equivalence tests
	 ...
	 *            class.
	 */
	public EquivalentableHashSet(GeoEpsilon _sop, int equivalConstant) {
		super();
		this.sop = _sop;
	 ...
	 *            class.
	 */
	public EquivalentableHashSet(int initialCapacity, GeoEpsilon _sop,
			int equivalConstant) {
	...
	public EquivalentableHashSet(int initialCapacity, float loadFactor,
			GeoEpsilon _sop, int equivalConstant) {
	 ...
	 *            class.
	 */
	public EquivalentableHashSet(Collection<Equivalentable> c, GeoEpsilon _sop,
			int equivalConstant) {
		super();
		this.sop = _sop;
		this.equConst = (byte) equivalConstant;
	 ...
	 * 
	 * @param _sop GeoEpsilon for equality/equivalence tests
	 * 
	 * @return int - the factor for rounding.
	 */
	private int computeFactor(GeoEpsilon _sop) {
