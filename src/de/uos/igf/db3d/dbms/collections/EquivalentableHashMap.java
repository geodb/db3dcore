...
public final class EquivalentableHashMap extends AbstractHashMap {
	 ...
	 *            class.
	 */
	public EquivalentableHashMap(GeoEpsilon _sop, int equivalConstant) {
		super();
		this.sop = _sop;
	 ...
	 *            class.
	 */
	public EquivalentableHashMap(int initialCapacity, GeoEpsilon _sop,
			int equivalConstant) {
	 ...
	 *            class.
	 */
	public EquivalentableHashMap(Map m, GeoEpsilon _sop, int equivalConstant) {
		super();
		this.sop = _sop;
		this.equConst = (byte) equivalConstant;
		this.factor = computeFactor(this.sop);
